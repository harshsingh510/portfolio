		...
		<div className='hero-section' name='home' id='home'>
			...
			<motion.div
				...
				<p className='hero-intro'>
					<span>Harsh Singh</span> 
				</p>
				<p className='hero-desc'>
					I'm a <span className='hero-desc-sub'>Web Developer / Competitive Programmer</span>
				</p>
			</motion.div>
			<motion.span
				...
				whileInView='visible'>
				<a
					href='HS_Resume_SDE (11) - Copy.pdf'
					download='Harsh Singh CV'
