...
const NavLinks = ({handleNav}) => {
  return (
    <ul className='nav-links'>
        ...
        <li onClick={handleNav} ><Link  to="https://www.linkedin.com/in/harsh-singh-90b887214/" target='_blank' className='nav-link'><FaLinkedin /></Link></li>
        <li onClick={handleNav} ><Link  to="https://github.com/harshsingh510" target='_blank' className='nav-link'><BsGithub /></Link></li>
